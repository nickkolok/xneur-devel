...
/* Define if you want debug support */
/* #undef WITH_DEBUG */

/* Define if you want enchant support */
#define WITH_ENCHANT 1

/* Define if you want gstreamer sound support */
#define WITH_GSTREAMER 1

/* Define if you want keylogger function */
#define WITH_KEYLOGGER 1

/* Define if you want libnotify message support */
#define WITH_LIBNOTIFY 1

/* Define if you want openal sound support */
/* #undef WITH_OPENAL */

/* Define if you want plugins support */
#define WITH_PLUGINS 1

/* Define if you want sound support */
#define WITH_SOUND 1

/* Define if you want xosd support */
#define WITH_XOSD 1
